							...
							<div class="row">
								...
								<div class="col-sm-3">
									<div class="single-item">
										<!-- Nếu có khuyến mãi thì hiện chữ sale trên đầu -->
										@if($new -> promotion_price != 0)
										<div class ="ribbon-wrapper"><div class ="ribbon sale">Sale</div></div>
										@endif
										<div class="single-item-header">
											<a href="{{route('chitietsanpham', $new->id)}}"><img src="public/source/image/product/{{$new -> image}}" alt="" height="250px"></a>
											</div>
						...
						<div class="beta-products-list">
							...
							<div class="row">
								...
								<div class="col-sm-3">
									<div class="single-item">
										<div class="single-item-header">
											<a href="{{route('chitietsanpham', $spkm->id)}}"><img src="public/source/image/product/{{$spkm->image}}" alt="" height="250px"></a>
										</div>
										<div class="single-item-body">
